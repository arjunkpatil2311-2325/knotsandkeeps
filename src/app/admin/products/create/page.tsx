      ...
      <form action={createProduct} className="space-y-8 divide-y-2 divide-black bg-white border-2 border-black shadow-[4px_4px_0_0_#000] rounded-xl p-6 sm:p-8">
        <div className="space-y-8 divide-y-2 divide-black sm:space-y-5">
            ...
            <div className="space-y-6 sm:space-y-5">
              <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t-2 sm:border-black sm:pt-5">
                ...
                <div className="mt-1 sm:mt-0 sm:col-span-2">
                  <input type="text" name="name" id="name" required className="max-w-lg block w-full bg-white border-2 border-black rounded-lg shadow-[inset_2px_2px_0px_0px_rgba(0,0,0,0.05)] p-2 font-bold text-black focus:ring-0 focus:border-black placeholder-black/50 sm:max-w-xs" />
                </div>
              </div>
              ...
              <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t-2 sm:border-black sm:pt-5">
                ...
                <div className="mt-1 sm:mt-0 sm:col-span-2">
                  <input type="text" name="slug" id="slug" required className="max-w-lg block w-full bg-white border-2 border-black rounded-lg shadow-[inset_2px_2px_0px_0px_rgba(0,0,0,0.05)] p-2 font-bold text-black focus:ring-0 focus:border-black placeholder-black/50 sm:max-w-xs" placeholder="e.g. rengoku-flame-bracelet" />
                </div>
              </div>
              ...
              <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t-2 sm:border-black sm:pt-5">
                ...
                <div className="mt-1 sm:mt-0 sm:col-span-2">
                  <textarea id="description" name="description" rows={5} className="max-w-lg block w-full bg-white border-2 border-black rounded-lg shadow-[inset_2px_2px_0px_0px_rgba(0,0,0,0.05)] p-2 font-bold text-black focus:ring-0 focus:border-black placeholder-black/50" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="pt-8 space-y-6 sm:pt-10 sm:space-y-5">
            ...
            <div className="space-y-6 sm:space-y-5">
              <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t-2 sm:border-black sm:pt-5">
                ...
                <div className="mt-1 sm:mt-0 sm:col-span-2">
                  <input type="number" step="0.01" name="price" id="price" required className="max-w-lg block w-full bg-white border-2 border-black rounded-lg shadow-[inset_2px_2px_0px_0px_rgba(0,0,0,0.05)] p-2 font-bold text-black focus:ring-0 focus:border-black placeholder-black/50 sm:max-w-xs" />
                </div>
              </div>
              ...
              <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t-2 sm:border-black sm:pt-5">
                ...
                <div className="mt-1 sm:mt-0 sm:col-span-2">
                  <input type="number" step="0.01" name="compare_at_price" id="compare_at_price" className="max-w-lg block w-full bg-white border-2 border-black rounded-lg shadow-[inset_2px_2px_0px_0px_rgba(0,0,0,0.05)] p-2 font-bold text-black focus:ring-0 focus:border-black placeholder-black/50 sm:max-w-xs" placeholder="For discounts" />
                </div>
              </div>
              ...
              <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t-2 sm:border-black sm:pt-5">
                ...
                <div className="mt-1 sm:mt-0 sm:col-span-2">
                  <input type="number" name="stock_quantity" id="stock_quantity" required defaultValue={0} className="max-w-lg block w-full bg-white border-2 border-black rounded-lg shadow-[inset_2px_2px_0px_0px_rgba(0,0,0,0.05)] p-2 font-bold text-black focus:ring-0 focus:border-black placeholder-black/50 sm:max-w-xs" />
                </div>
              </div>
              ...
              <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t-2 sm:border-black sm:pt-5">
                ...
                <div className="mt-1 sm:mt-0 sm:col-span-2">
                  <input type="text" name="sku" id="sku" className="max-w-lg block w-full bg-white border-2 border-black rounded-lg shadow-[inset_2px_2px_0px_0px_rgba(0,0,0,0.05)] p-2 font-bold text-black focus:ring-0 focus:border-black placeholder-black/50 sm:max-w-xs" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="pt-8 space-y-6 sm:pt-10 sm:space-y-5">
            ...
            <div className="space-y-6 sm:space-y-5">
              <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t-2 sm:border-black sm:pt-5">
                <label htmlFor="images" className="block text-sm font-black text-black uppercase tracking-wider sm:mt-px sm:pt-2">Product Images</label>
                <div className="mt-1 sm:mt-0 sm:col-span-2">
                  ...
                  <p className="mt-2 text-sm text-black font-bold">First image will be used as the primary image.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="pt-8 space-y-6 sm:pt-10 sm:space-y-5">
            ...
            <div className="space-y-6 sm:space-y-5">
              ...
              <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t-2 sm:border-black sm:pt-5">
                ...
                <div className="mt-1 sm:mt-0 sm:col-span-2">
                  <select id="status" name="status" className="max-w-lg block w-full bg-white border-2 border-black rounded-lg shadow-[inset_2px_2px_0px_0px_rgba(0,0,0,0.05)] p-2 font-bold text-black focus:ring-0 focus:border-black sm:max-w-xs">
                ...
                <div className="mt-1 sm:mt-0 sm:col-span-2 space-y-4">
                  <div className="flex items-start">
                    <div className="flex items-center h-5">
                      <input id="show_on_homepage" name="show_on_homepage" type="checkbox" className="focus:ring-0 h-5 w-5 text-black bg-white border-2 border-black rounded-sm" />
                    </div>
                  ...
                  <div className="flex items-start">
                    <div className="flex items-center h-5">
                      <input id="is_featured" name="is_featured" type="checkbox" className="focus:ring-0 h-5 w-5 text-black bg-white border-2 border-black rounded-sm" />
                    </div>
                    <div className="ml-3 text-sm">
                  ...
                  <div className="flex items-start">
                    <div className="flex items-center h-5">
                      <input id="is_bestseller" name="is_bestseller" type="checkbox" className="focus:ring-0 h-5 w-5 text-black bg-white border-2 border-black rounded-sm" />
                    </div>
                    <div className="ml-3 text-sm">
                  ...
                  <div className="flex items-start">
                    <div className="flex items-center h-5">
                      <input id="is_new_arrival" name="is_new_arrival" type="checkbox" className="focus:ring-0 h-5 w-5 text-black bg-white border-2 border-black rounded-sm" />
                    </div>
                    <div className="ml-3 text-sm">
